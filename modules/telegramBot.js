...
Чтобы приобрести USDT, нажмите кнопку "Обмен".`, {
    reply_markup: {
      keyboard: [
        ...
        [
          { text: '💵 Создать заявку на покупку USDT' },
          { text: '💵 Создать заявку на продажу USDT' }
        ],
        [
        { text: "📞 Связаться с нами" }, // Вторая кнопка на второй строке
...
Для получения пропуска к нам в офис и покупки USDT, вам нужно создать заявку - нажмите на кнопку "Обмен"`);
  ...
  } else if (text === "💵 Создать заявку на покупку USDT") {
    bot.sendMessage(chatId, "Для создания ордера на покупку нажмите на кнопку ниже:", {
      reply_markup: {
        inline_keyboard: [
          [
            { text: "💵 Создать ордер на покупку", url: process.env.LINK_BUY }
          ]
        ]
      }
    });
  } else if (text === "💵 Создать заявку на продажу USDT") {
    bot.sendMessage(chatId, "Для создания ордера на продажу нажмите на кнопку ниже:", {
      reply_markup: {
        inline_keyboard: [
          [
            { text: "💵 Создать ордер на продажу", url: process.env.LINK_SELL }
          ]
        ]
      }
    });
